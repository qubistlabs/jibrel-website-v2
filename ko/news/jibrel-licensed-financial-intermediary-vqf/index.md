...
**ZUG SWITZERLAND / ACCESSWIRE / May 22, 2018 /** Jibrel AG is now an official member of the Association for the Quality Assurance of Financial Services (VQF), confirming its status as a licensed financial intermediary in the Swiss para banking sector. VQF is the oldest and largest cross-industry Self-Regulatory Organization (SRO) to meet the criteria set forth by the Financial Services Standards Association (FINMA).
...
Jibrel's Founder and CEO Yazan Barghuthi expressed concerns with Tether’s approach in a recent interview with TechCrunch, observing that, "in tether, users purchased USDT directly from an exchange, whereas in Jibrel, one purchases JNT and then uses that to purchase asset-backed tokens from the Jibrel DAO."
