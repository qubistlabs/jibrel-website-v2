...
module.exports = {
    ...
    entry: prepareEntryPoints({
        main: path.resolve(`${cwd}/src/${staticFolderName}/js/main.js`)
    }),
    ...
    resolve: {
        alias: {
            modules: path.resolve(`./src/${tars.config.fs.componentsFolderName}`),
            components: path.resolve(`./src/${tars.config.fs.componentsFolderName}`),
            static: path.resolve(`./src/${staticFolderName}`)
        }
    },
