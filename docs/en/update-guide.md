...
* transfer the folder src from the current project to a new TARS;
...
Also, if you have changed builder files (anything else, except src folder), it is necessary to apply these changes manually. All recent changes available in [changelog](changelog.md).
