...
## The Current State of the Internet Today

As of December of 2018, there were over [4.1 billion internet](https://hostingfacts.com/internet-facts-stats/) users and 342 million registered domain names. While this may seem like a lot, the internet we know today is far from decentralized. Several giant internet companies (like Facebook, Netflix, Google, Amazon) control over 90% of internet traffic and store massive amounts of user data on private servers. This allows them to control things such as:

1. Who has access to the services and to what extent
2. Rules of engagement on their platform
3. Collection and sale of user data

Every view, click and micro-moment is analyzed, optimized and then either sold off to advertisers. Typically, this data collection tends to result in better products and more relevant ads for things people actually want or need. Yet as the more recent [US election](https://www.theguardian.com/news/2018/mar/17/cambridge-analytica-facebook-influence-us-election) would show, the loopholes of such a system could easily be manipulated by bad actors to alter the direction of an entire country. Furthermore, centralized applications are prime targets for hacks and server issues. Some most prominent hacks include:

**[T-Mobile](https://www.vice.com/en_us/article/a3qpk5/t-mobile-hack-data-breach-api-customer-data)**: In 2018, over 2 million T-Mobile customer, had their personal data stolen by hackers. However, the company claimed that no financial data or passwords were compromised.

**[Yahoo](https://en.wikipedia.org/wiki/Yahoo!_data_breaches):** In September of 2016, over 500 million Yahoo user accounts were compromised. For Yahoo, this was not an isolated incident as it followed a 3 billion account hack in 2013.

**[Ebay:](https://money.cnn.com/2014/05/21/technology/security/ebay-passwords/index.html)** Over 145 million user accounts were compromised in 2014 as crooks had utilized employee credentials for their own purposes. Hackers had plenty of time to move as much data as they needed before anyone realized something was wrong.
