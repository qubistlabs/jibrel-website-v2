...
Blockchain is supposed to be able to save companies and customers from the costly and inefficient systems of today. Ironically, blockchain itself may be quite expensive to run. You may have heard debates regarding [Bitcoin’s high energy consumption](https://www.economist.com/the-economist-explains/2018/07/09/why-bitcoin-uses-so-much-energy). The current global power consumption for the servers that run Bitcoin’s software is a minimum of 22 terawatt-hours (TWh) per year. This is equivalent to the entire country of Poland or Ireland. While [green mining solutions](https://www.hydrominer.org/) are being implemented, they will need to be far more scalable to fully combat this issue.

### Lacking IOT Infrastructure
