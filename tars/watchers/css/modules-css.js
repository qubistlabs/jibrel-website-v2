...
module.exports = () => {
    return tars.packages.chokidar.watch(
        `src/${tars.config.fs.componentsFolderName}/**/*.${tars.cssPreproc.ext}`,
        Object.assign(tars.options.watch, {
            ignored: [
                `src/${tars.config.fs.componentsFolderName}/**/ie8.${tars.cssPreproc.ext}`,
                `src/${tars.config.fs.componentsFolderName}/**/ie9.${tars.cssPreproc.ext}`,
                `src/${tars.config.fs.componentsFolderName}/**/ie8.css`,
                `src/${tars.config.fs.componentsFolderName}/**/ie9.css`
            ]
        })
