...
const jsPaths = [].concat.apply([], [
    `!./src/${tars.config.fs.componentsFolderName}/**/data/data.js`,
    '!./src/**/_*.js',
    `./src/${staticFolderName}/js/framework/**/*.js`,
    `./src/${staticFolderName}/js/libraries/**/*.js`,
    `./src/${staticFolderName}/js/plugins/**/*.js`,
    tars.config.js.jsPathsToConcatBeforeModulesJs,
    `./src/${tars.config.fs.componentsFolderName}/**/*.js`,
    tars.config.js.jsPathsToConcatAfterModulesJs,
    `!./src/${staticFolderName}/js/separate-js/**/*.js`
]);
