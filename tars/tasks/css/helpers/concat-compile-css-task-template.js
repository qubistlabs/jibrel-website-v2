...
module.exports = function generateTaskContent(browser) {
    ...
    const stylesFolderPath = `./src/${tars.config.fs.staticFolderName}/${preprocName}`;
    ...
    const generalStylesFilesToConcatinate = [
        ...
        `./src/${tars.config.fs.componentsFolderName}/**/*.${preprocExtensions}`,
        `./src/${tars.config.fs.componentsFolderName}/**/*.css`
    ];
    ...
    switch (browser) {
        case 'ie8':
            stylesFilesToConcatinate.push(
                ...
                `./src/${tars.config.fs.componentsFolderName}/**/ie/ie8.${preprocExtensions}`,
                `./src/${tars.config.fs.componentsFolderName}/**/ie/ie8.css`,
        ...
        case 'ie9':
            ...
            stylesFilesToConcatinate.push(
                generalStylesFilesToConcatinate,
                `./src/${tars.config.fs.componentsFolderName}/**/ie/ie9.${preprocExtensions}`,
                `./src/${tars.config.fs.componentsFolderName}/**/ie/ie9.css`,
                lastStylesFilesToConcatinate
            );
