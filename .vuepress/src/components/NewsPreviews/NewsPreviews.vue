  ...
  <div class='news-preview'>
    <div class='item' data-aos='fade-down' data-aos-duration='300' data-aos-delay='250' v-for='post in posts'>
      <router-link :to='post.path' class='box' :class='isBordered && "-border"'>
        <div class='pic'><img :src='$withBase(post.frontmatter.img)' :srcset='`${ post.frontmatter.img2x } 2x`' alt='Al Hilal Bank executes the world&#x27;s first Blockchain Sukuk transaction' class='img'></div>
        <div class='body'>
