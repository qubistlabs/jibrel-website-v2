...
![Jibrel Network logo on blue background](@/../../_img/content/973j9uegb3t8y48tq84-09t.jpg)
...
How? First: by setting the standard for [cryptofiats](https://en.wiktionary.org/wiki/cryptofiat) with smart contracts. Cryptofiats refer to government-issued cryptocurrencies, typically backed by the central bank of said government. In other words, they're dollars, euros, or any other fiat currency underlaid by blockchain technology.
...
For a refresher on smart contracts, take a look at [this piece](https://motherboard.vice.com/en_us/article/pgaxjz/smart-contracts-sound-boring-but-theyre-more-disruptive-than-bitcoin) in Motherboard. "Blockchains are a database, a new way of storing data in a particular contract,"Barghuthi said. "Smart contracts are a way to execute certain commands in a decentralized way, and be able to remove trusted intermediaries, or middlemen, from the equation."

Jibrel Network functionalityJibrel Network

## MORE FROM FORBES

With a smart contract, respective parties set terms and agree to them through blockchain, and these agreements are executed automatically henceforth. Ethereum introduced the concept, but now a host of other blockchain networks employ them, including [Cardano](https://www.forbes.com/sites/jessedamiani/2017/12/16/crypto-watch-cardano-ada-price-leaps-117-in-22-hours-surging-past-iota-with-10-4b-market-cap/#121154708abe), [NEO](http://docs.neo.org/en-us/sc/introduction.html), [TRON](https://www.forbes.com/sites/jessedamiani/2017/12/14/crypto-watch-tron-trx-price-surges-over-500-in-a-week-outperforming-btc-ltc-and-eth/#718158873350), [Qtum](https://www.forbes.com/sites/jessedamiani/2017/12/18/crypto-watch-qtum-price-leaps-189-in-8-hours-what-is-qtum-and-why-is-it-growing-so-fast/#117091b355fc), among many others. Each of these networks implements smart contracts through their own "in-house" tokens. What Jibrel is doing is figuring out how you could enable this same system, but with traditional currencies. This applies for everyday use—the way you as an individual might use Venmo or PayPal—but maybe more importantly optimizes how governments and financial service companies can conduct transactions.
...
![Example of how Jibrel CryDR smartphone app could look like](@/../../_img/content/Fphone-new_2.wfwfwf30j.jpg)
...
![Example of how Jibrel wallet desktop app could look like](@/../../_img/content/FScreen-Shot-2018-01-21-at-3.19.33-PM-1200x681.jpg)
...
To formally launch Jibrel, the Jibrel Network [Token Sale](https://sale.jibrel.network) began on Nov. 27, ultimately closing its hard cap [a full month ahead of schedule on Dec. 27](https://venturebeat.com/2018/01/17/jibrel-launches-jcash-in-a-bid-to-solve-cryptocurrency-volatility-by-tokenizing-fiat/)—demonstrating a clear industry belief in their cryptofiat token model.

For more information on Jibrel Network, visit the [official website](https://jibrel.network/), the company [blog](https://medium.com/@jibrelnetwork), or join the [Telegram channel](https://t.me/jibrelnetwork).
